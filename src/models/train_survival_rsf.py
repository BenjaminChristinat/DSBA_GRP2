...
FEATURES_PATH = Path("data/features/location_competition_features.parquet")
FINAL_CORE_PATH = Path("data/interim/FINAL/FINAL_MERGED_WITH_OSM_GOOGLE_CITIES_ONLY.csv")
CLOSED_VENUES_PATH = Path("data/raw/Closed_OSM_ohsome/closed_food_venues_7y copy.csv")
SURVIVAL_DATASET_PATH = Path("data/processed/closure_survival_dataset.parquet")
MATCHED_EXPORT_PATH = Path("data/processed/matched_closed_venues.csv")
