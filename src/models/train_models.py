...
# Paths
FEATURE_PATH = Path("data/features/location_competition_features.parquet")
MODELS_DIR = Path("models")
ARTIFACTS_DIR = Path("artifacts")
COVID_TS_FILES = [
    Path("data/processed/reviews_timeseries_interlaken.csv"),
    Path("data/processed/reviews_timeseries_sion.csv"),
]
