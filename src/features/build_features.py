...
``data/features`` – it never modifies the input databases.
"""
...
# File defaults
DEFAULT_CORE_PATH = Path("data/interim/FINAL/FINAL_MERGED_WITH_OSM_GOOGLE_CITIES_ONLY.csv")
DEFAULT_EXTENDED_PATH = Path("data/interim/FINAL/FINAL_MERGED_ALL_SOURCES_ALL_AREA.csv")
DEFAULT_MICRO_POI_PATH = Path("data/reference/collectors/osm/swiss_microlocation_poi.csv")
DEFAULT_OUTPUT_PATH = Path("data/features/location_competition_features.parquet")
